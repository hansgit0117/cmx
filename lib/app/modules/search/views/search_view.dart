  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(
        children: [
          buildSearchBar(),
          SearchServicesListWidget(expiringContracts: controller.expiringContractsAfterSearch),
        ],
      ),
    );
  }
            ...
            Expanded(
              child: Material(
                ...
                child: TextField(
                  ...
                  onChanged: (value) {
                    controller.searchContract(keywords: value);
                  },
                  onSubmitted: (value) {
                    controller.searchContract(keywords: value);
                  },
                  ...
                  decoration: Ui.getInputDecoration(hintText: "Search for contracts...".tr),
                ),
              ),
            ),
            SizedBox(width: 8),
